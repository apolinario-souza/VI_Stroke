...
balao = load_image(os.path.join('img', 'balao_vermelho.png'), (int(screen_width*0.12), int(screen_width*0.12)))
pedra_img = load_image(os.path.join('img', 'pedra.png'), (int(screen_width*0.05), int(screen_width*0.05)))
balao_explodindo_img = load_image(os.path.join('img', 'balao_esplodindo.png'), (int(screen_width*0.13), int(screen_width*0.13)))
...
boca_aberta = load_boca(os.path.join('img', 'mao.png'))
boca_fechada = load_boca(os.path.join('img', 'mao_pedra.png'))
